        ...
        <div className="cartao" style={{ padding: 14, marginTop: 12, borderLeft: `4px solid ${r.hta ? "#dc2626" : "#059669"}` }}>
          {!r.hta ? (
            ...
            <>
              ...
              <div style={{ fontSize: 12.5, color: "var(--texto)", marginTop: 8 }}><strong>Conduta:</strong> confirmar em mais 2 ocasiões separadas. Se persistir: referenciação programada a Pediatria (investigação de HTA secundária).</div>
...
export function Snellen() {
  ...
  return (
    <div>
      ...
      <Bloco titulo="Referenciar a Oftalmologia" cor="#dc2626"><Linhas itens={s.referenciar} /></Bloco>
